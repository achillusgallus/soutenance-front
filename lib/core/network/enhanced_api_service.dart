...
class EnhancedApiService {
  ...
  ApiException _handleError(DioException error) {
    switch (error.type) {
      ...
      case DioExceptionType.receiveTimeout:
        return ApiException('Délai de connexion dépassé. Vérifiez votre connexion.', error.response?.statusCode);
      ...
      case DioExceptionType.connectionError:
        return ApiException('Erreur de connexion. Vérifiez votre internet.', error.response?.statusCode);
      
      case DioExceptionType.unknown:
        return ApiException('Erreur réseau inconnue. Réessayez plus tard.', error.response?.statusCode);
      
      default:
        return ApiException('Erreur inattendue: ${error.message}', error.response?.statusCode);
    }
  }
  ...
  ApiException _handleHttpError(DioException error) {
    ...
    switch (statusCode) {
      ...
      case 401:
        return ApiException('Session expirée. Veuillez vous reconnecter.', statusCode);
      case 403:
        return ApiException('Accès refusé. Permissions insuffisantes.', statusCode);
      case 404:
        return ApiException('Ressource non trouvée.', statusCode);
      case 422:
        return ApiException('Données invalides: $message', statusCode);
      case 429:
        return ApiException('Trop de requêtes. Attendez avant de réessayer.', statusCode);
      case 500:
        return ApiException('Erreur serveur interne. Réessayez plus tard.', statusCode);
      case 503:
